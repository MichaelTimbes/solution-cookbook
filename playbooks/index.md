...
| [Legal Case Management](legal-case-management/guide.md) | Case / Ticket Archetype Variant | A legal matter workflow with chain-of-custody, review controls, and defensible audit history. |
| [Compliance Case Management](compliance-case-management/guide.md) | Case / Ticket Archetype Variant | A compliance investigation lifecycle for findings, remediation, and policy-governed closure. |
...
| [Vendor Management System](vendor-management-system/guide.md) | CRM Archetype Variant | A supplier lifecycle platform for onboarding, qualification, risk review, and renewal. |
| [Patient Relationship Management](patient-relationship-management/guide.md) | CRM Archetype Variant | A patient engagement lifecycle platform with consent-aware outreach and follow-up workflows. |
...
| [Records Management System](records-management-system/guide.md) | Document Management Archetype Variant | A records governance platform for retention, legal hold, disposition, and compliance reporting. |
| [Clinical Document Management](clinical-document-management/guide.md) | Document Management Archetype Variant | A clinical document lifecycle platform with secure access, signoff, and traceable versioning. |
...
| [Task Orchestration Platform](task-orchestration-platform/guide.md) | Workflow / BPM Archetype Variant | A dependency-aware task execution platform with retries, tracing, and operational controls. |
| [Compliance Process Tracking](compliance-process-tracking/guide.md) | Workflow / BPM Archetype Variant | A compliance workflow tracker for attestations, remediation, evidence, and closure governance. |
