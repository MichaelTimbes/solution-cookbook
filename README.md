...
Solution Cookbook is a reference repository for composing enterprise systems from:
...
The current V2 catalog is intentionally scoped to the active playbooks listed in [playbooks/index.md](playbooks/index.md).
